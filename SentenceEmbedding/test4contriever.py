...
if __name__ == "__main__":
    ...
    parser.add_argument("--test_sentence", type=str, default="when did vivo launch first smartphone in india") # test841
    ...
    args.doc_info = "In June 2017, Vivo reached a sponsorship deal with FIFA to become the official smartphone brand of the 2018 and 2022 FIFA World Cups.[16] The company also became title sponsor of India's Pro Kabaddi.[17]"
    main(args)