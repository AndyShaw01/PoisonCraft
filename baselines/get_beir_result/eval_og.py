...
parser.add_argument('--model_code', type=str, default="dpr-single")
...
parser.add_argument('--result_output', default="results/beir_results/tmp_dpr_nq.json", type=str)
