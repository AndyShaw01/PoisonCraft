...
if mode == "retriever":
    file_path = f'Result/main_result/{retriever}/{dataset}_trans.csv'  # 替换为您实际的文件路径
    ...
    file_path = f'Result/main_result/attack/{retriever}/{dataset}/top{topk}/main_result.csv'
    df = pd.read_csv(file_path)
