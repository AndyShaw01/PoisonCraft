...
do
    ...
    do
        TEST_FILE="./Dataset/nq/category/categorized_jsonl_files_14_test/category_${GROUP_INDEX}.jsonl"
        LOG_PATH_PRE="Logs/tmp_data/GCG-Batch-${ATTACK_BATCH_SIZE}-${GROUP_MODE}-category_${GROUP_INDEX}-test"
