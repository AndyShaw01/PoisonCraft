...
TOPK_LIST=30
TARGET_DATASET="hotpotqa" # hotpotqa, hotpotqa
MODE="test" # test
...
do
    ...
    do
        ...
        python -u "$PYTHON_PRE_SCRIPT" --k $TOP_K --category $GROUP_INDEX --train_queries_path $TEST_FILE --dataset ${TARGET_DATASET} # > "$LOG_PATH_PRE/get_ground_truth_${TOP_K}_.log" 2>&1
    done
done
